                ...
                <div className="col-12 row justify-content-center vh-100 align-items-center">
                    ...
                    (<form className="col-5 form-bdr">
                        ...
                        <div className="col-12">
                            ...
                            {err && tname==="" ? <p>Task description required</p>:""}
                        </div>

                        <div className="col-12 row radio justify-content-center">
                            <div className="col-5 text-center">
                                <label htmlFor="completed">Completed</label>
                                <input type="radio" id="completed" name="radio" onChange={run}></input>
                            </div>
                            <div className="col-5 text-center">
                                <label htmlFor="notcompleted">Not Completed</label>
                                <input type="radio" id="notcompleted" name="radio" onChange={run}></input>
                            </div>
                            {err && tname==="" ? <p>Task status required</p>:""}
                        </div>
